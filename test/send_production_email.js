...
async function sendProductionEmail() {
  console.log('📧 Sending rejection email with correct production domain...')
  ...
  try {
    ...
    console.log('🔗 Using correct production URL:', updateApplicationUrl)
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <div style="background-color: #f5f5f5; padding: 40px 20px;">
    ...
    if (response.ok) {
      ...
      console.log('🔗 Working URL:', updateApplicationUrl)
      console.log('📝 Email ID:', result.id)
      console.log('\n💡 The link uses www.onedesigner.app where the API actually works!')
    } else {
