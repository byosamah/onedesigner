...
declare global {
  namespace Cypress {
    interface Chainable {
      ...
      verifyDiscountApplied(code: string, discount: number, description: string): Chainable<void>
      removeDiscountCode(): Chainable<void>
      purchaseWithFreeCode(packageType: 'STARTER_PACK' | 'GROWTH_PACK' | 'SCALE_PACK', discountCode?: string): Chainable<void>
