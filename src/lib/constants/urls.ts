...
export const EXTERNAL_URLS = {
  SUPABASE: {
    // Project ref should be set via NEXT_PUBLIC_SUPABASE_PROJECT_REF environment variable
    DASHBOARD: `https://supabase.com/dashboard/project/${process.env.NEXT_PUBLIC_SUPABASE_PROJECT_REF || 'YOUR_PROJECT_REF'}`,
    SQL_EDITOR: `https://supabase.com/dashboard/project/${process.env.NEXT_PUBLIC_SUPABASE_PROJECT_REF || 'YOUR_PROJECT_REF'}/sql/new`
  },
  SOCIAL: {
