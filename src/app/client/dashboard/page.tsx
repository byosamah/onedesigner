...
export default function ClientDashboard() {
  ...
  const [selectedMatchForUnlock, setSelectedMatchForUnlock] = useState<string | null>(null)
  ...
  const handleUnlockClick = (matchId: string) => {
    setSelectedMatchForUnlock(matchId)
    setShowUnlockModal(true)
  }

  const handleUnlockConfirm = async () => {
    if (!selectedMatchForUnlock) return

    try {
      const response = await fetch(`/api/client/matches/${selectedMatchForUnlock}/unlock`, {
        method: 'POST',
        credentials: 'include',
      })
      ...
      setSelectedMatchForUnlock(null)
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          >
            ...
            <div className="text-3xl font-bold mb-1" style={{ color: theme.accent }} data-testid="credits-display">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 mt-3 text-xs" style={{ color: theme.text.muted }}>
                        <span>Match Score: <strong style={{ color: theme.accent }} data-testid="match-score">{match.score}%</strong></span>
                  ...
                  <div className="flex items-center gap-3 ml-4">
                    {match.status === 'pending' && client?.match_credits > 0 && (
                      <button
                        onClick={() => handleUnlockClick(match.id)}
                ...
                {match.status === 'unlocked' && (
                  ...
                  >
                    ...
                    {/* Contact Information */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4" data-testid="designer-contact">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {(!match.workingRequest || match.workingRequest.status === 'declined') && (
                        <button
                          ...
                          className="font-semibold py-2 px-6 rounded-xl transition-all duration-300 hover:scale-[1.02]"
                          data-testid="send-working-request-btn"
                          style={{
                            backgroundColor: theme.accent,
                            color: '#000'
                          }}
      ...
      {showUnlockModal && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div
              className="relative max-w-sm w-full rounded-3xl p-6 animate-slideUp"
              style={{
                backgroundColor: theme.cardBg,
                border: `1px solid ${theme.border}`,
            ...
            >
              <div className="text-center">
                ...
                <p className="text-sm mb-6" style={{ color: theme.text.secondary }}>
                  This will use 1 match credit to unlock the designer's full contact information.
                </p>
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 px-4 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-[1.02]"
                    style={{
                      backgroundColor: 'transparent',
                      border: `1px solid ${theme.border}`,
                      color: theme.text.primary
