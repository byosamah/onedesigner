...
export default function BlogListingClient() {
  ...
  const filteredPosts = posts.filter(post => {
    const preview = post.preview || post.preview_text || '';
    const category = post.category || 'design-tips';
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      >
                        🎯 {formatCategory(post.category || 'design-tips')}
                      </span>
                    ...
                    <p className="line-clamp-3 mb-4" style={{ color: theme.text.secondary }}>
                      {post.preview || post.preview_text}
                    </p>
