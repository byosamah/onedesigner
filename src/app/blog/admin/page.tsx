              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    style={{ 
                      backgroundColor: enhancedFields.has('title') ? undefined : theme.background.primary,
                      borderColor: enhancedFields.has('title') ? undefined : theme.border.primary,
                ...
                <div>
                  ...
                  <textarea
                    ...
                    style={{ 
                      backgroundColor: enhancedFields.has('preview') ? undefined : theme.background.primary,
                      borderColor: enhancedFields.has('preview') ? undefined : theme.border.primary,
                      color: theme.text.primary
                    }}
