...
export default function MatchRedesignPageNew() {
  ...
  if (isLoading) {
    return (
      <main className="min-h-screen flex items-center justify-center transition-colors duration-300" style={{ 
        backgroundColor: theme.bg,
        fontFamily: 'var(--font-bricolage), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
        ...
        <div className="text-center">
          ...
          <div className="space-y-2" style={{ color: theme.text.secondary }}>
            <p className="animate-pulse">Analyzing project requirements...</p>
            <p className="animate-pulse" style={{ animationDelay: '200ms' }}>Matching design styles...</p>
            <p className="animate-pulse" style={{ animationDelay: '400ms' }}>Calculating compatibility scores...</p>
          </div>
        </div>
      </main>
    )
  ...
  return (
    <main className="min-h-screen transition-colors duration-300" style={{ 
        backgroundColor: theme.bg,
        fontFamily: 'var(--font-bricolage), -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
        WebkitFontSmoothing: 'antialiased',
        MozOsxFontSmoothing: 'grayscale'
