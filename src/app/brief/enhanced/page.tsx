...
export default function EnhancedBriefPage() {
  ...
  const handleBriefSubmit = async (data: ClientBriefData) => {
    try {
      ...
      // Redirect to enhanced match results
    ...
    >
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            Tell us about your project with our enhanced questionnaire for better designer matching
          </p>
        </div>
