...
export default function MatchRedesignLightPage() {
  ...
  if (isLoading) {
    return (
      <main className={`min-h-screen flex items-center justify-center ${styles.shipfastPage}`} style={{ backgroundColor: '#FAFAFA' }}>
        <div className="text-center">
          <div className="text-5xl mb-6">✨</div>
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Finding your perfect designer...</h2>
    ...
    <main className={`min-h-screen ${styles.shipfastPage}`} style={{ backgroundColor: '#FAFAFA' }}>
      ...
      <nav className="px-8 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <Link href="/client/dashboard" className="text-gray-600 hover:text-gray-900 text-sm font-medium transition-colors">
              Dashboard
            </Link>
            <div className="text-white px-4 py-2 rounded-full text-sm font-semibold" style={{ backgroundColor: '#f0ad4e' }}>
              {credits} Credits
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-8 py-12">
        ...
        <div className="text-center mb-12">
          <div className="text-5xl mb-6">🎯</div>
          <h1 className="text-5xl font-extrabold mb-4 text-gray-900">Perfect Match Found!</h1>
        ...
        <div className="bg-white rounded-3xl border border-gray-200 p-8 mb-8 shadow-sm">
          ...
          <div className="flex items-start justify-between mb-8">
            <div className="flex items-center gap-6">
              <div className={`w-20 h-20 rounded-full flex items-center justify-center text-2xl font-bold text-white ${!isUnlocked && 'blur-sm'}`} style={{ backgroundColor: '#f0ad4e' }}>
          ...
          {/* Key Strengths */}
          <div className="mb-8">
            <h3 className="font-bold text-lg mb-4 text-gray-900">Why {mockMatch.designer.firstName} is perfect for you</h3>
          ...
          <div className="grid grid-cols-2 gap-6 mb-8">
            <div>
              <h4 className="font-semibold mb-3 text-gray-900">Design Styles</h4>
              <div className="flex flex-wrap gap-2">
                {mockMatch.designer.styles.map((style) => (
                  <span key={style} className="px-4 py-2 rounded-lg text-sm text-gray-700 bg-gray-100">
                    {style}
                  </span>
                ))}
              </div>
            ...
            <div>
              <h4 className="font-semibold mb-3 text-gray-900">Industries</h4>
              <div className="flex flex-wrap gap-2">
                {mockMatch.designer.industries.map((industry) => (
                  <span key={industry} className="px-4 py-2 rounded-lg text-sm text-gray-700 bg-gray-100">
                    {industry}
                  </span>
                ))}
              </div>
          ...
          {/* Portfolio Preview */}
          <div className="mb-8">
            <h4 className="font-semibold mb-4 text-gray-900">Portfolio Preview</h4>
          ...
          {!isUnlocked ? (
            <div className="border-t border-gray-200 pt-8">
              <div className="text-center mb-6">
                <h3 className="font-bold text-xl mb-2 text-gray-900">Ready to connect with {mockMatch.designer.firstName}?</h3>
              ...
              <div className="bg-gray-50 rounded-2xl p-6 mb-6">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700">Full name & contact info</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span style={{ color: '#f0ad4e' }}>✓</span>
                    <span className="text-gray-700">Direct email & phone</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span style={{ color: '#f0ad4e' }}>✓</span>
                    <span className="text-gray-700">Complete portfolio access</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span style={{ color: '#f0ad4e' }}>✓</span>
                    <span className="text-gray-700">Calendly booking link</span>
                  </div>
                </div>
              </div>
              ...
              {credits > 0 ? (
                <button
                  ...
                  className="w-full text-white font-bold py-4 rounded-2xl transition-all mb-4 hover:scale-[1.02] shadow-sm" 
              ...
              {/* Pricing Cards */}
              <div className="grid grid-cols-3 gap-4">
                <button className="p-6 border-2 border-gray-200 bg-white rounded-2xl hover:border-gray-300 transition-all text-center hover:scale-[1.02] shadow-sm">
                  <div className="text-2xl font-bold mb-1 text-gray-900">$5</div>
                  <div className="font-medium mb-1 text-gray-700">Starter</div>
                  <div className="text-sm text-gray-500">3 matches</div>
                </button>
                <button className="p-6 border-2 rounded-2xl transition-all text-center relative hover:scale-[1.02] shadow-md" style={{ borderColor: '#f0ad4e', backgroundColor: '#FFF9F0' }}>
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 text-white text-xs px-3 py-1 rounded-full font-semibold" style={{ backgroundColor: '#f0ad4e' }}>
                    MOST POPULAR
                  </div>
                  <div className="text-2xl font-bold mb-1 text-gray-900">$15</div>
                  <div className="font-medium mb-1 text-gray-700">Growth</div>
                  <div className="text-sm text-gray-500">10 matches</div>
                </button>
                <button className="p-6 border-2 border-gray-200 bg-white rounded-2xl hover:border-gray-300 transition-all text-center hover:scale-[1.02] shadow-sm">
                  <div className="text-2xl font-bold mb-1 text-gray-900">$30</div>
                  <div className="font-medium mb-1 text-gray-700">Scale</div>
            ...
            <div className="border-t border-gray-200 pt-8">
              <div className="bg-yellow-50 rounded-2xl p-6 mb-6">
                <h3 className="font-bold text-lg mb-4 text-gray-900">Contact Details</h3>
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <span className="text-gray-500">📧</span>
                    <span className="text-gray-700">{mockMatch.designer.email}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-gray-500">📱</span>
                    <span className="text-gray-700">{mockMatch.designer.phone}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-gray-500">🗓</span>
              ...
              <div className="text-center">
                <h4 className="font-bold mb-3 text-gray-900">Next Steps</h4>
